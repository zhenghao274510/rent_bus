<template>
  <div class="testdrive">
      <ul>
        <li><span>产品介绍</span><img src="./img/fanhui-2@2x.png" alt=""></li>
        <li><span>基础条件</span><img src="./img/fanhui-2@2x.png" alt=""></li>
        <li><span>产品规则</span><img src="./img/fanhui-2@2x.png" alt=""></li>
      </ul>
